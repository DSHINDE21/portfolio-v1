...
export function Heart(props) {
  return (
    ...
    >
      <path
        fill="#ff473e"
        d="M476.6 133c-53.7-63.5-148.7-66.5-206.3-9.1l-.2.2c-8 8-20.5 8-28.4 0l-.2-.2c-54.6-54.8-143.3-55-198.1-.4C-3.2 169.8-10.9 244.6 25 299.7c11.2 17.3 25.3 30.6 40.9 40.7l180 145.7c6.4 5.2 15.6 5.2 22.1 0l178.8-145.9c15-10 28.6-23 39.5-39.5c34.1-51.3 30.1-120.7-9.7-167.7"
      ></path>
      <path
        fill="#ff6e83"
        d="M58.7 242.6c-.6 0-1.3 0-1.9-.1c-12.9-1.1-22.5-12.4-21.5-25.3c3.8-45.9 36.5-83.5 81.5-93.5c12.6-2.8 25.2 5.1 28 17.8c2.8 12.6-5.1 25.2-17.8 28c-24.8 5.5-42.9 26.3-45 51.6c-1 12.2-11.2 21.5-23.3 21.5"
      ></path>
    </svg>
  );
}
...
export function Codechef(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="2.3em"
    ...
    >
      ...
      ></path>
      <radialGradient
        id="wjR_Oe2ayoe3fGfJhyhbca_LnZMjt9rZC3d_gr1"
        cx="20.66"
        cy="13.128"
        r="18.437"
      ...
      >
        ...
        <stop offset=".293" stopColor="#f6f7f8"></stop>
        <stop offset=".566" stopColor="#ebecee"></stop>
        <stop offset=".832" stopColor="#d8dcdf"></stop>
        <stop offset="1" stopColor="#c8cdd1"></stop>
      </radialGradient>
      <path
        fill="url(#wjR_Oe2ayoe3fGfJhyhbca_LnZMjt9rZC3d_gr1)"
      ...
      ></path>
      <radialGradient
        id="wjR_Oe2ayoe3fGfJhyhbcb_LnZMjt9rZC3d_gr2"
        cx="11.72"
        cy="7.271"
        r=".104"
        gradientUnits="userSpaceOnUse"
      ...
      <path
        fill="url(#wjR_Oe2ayoe3fGfJhyhbcb_LnZMjt9rZC3d_gr2)"
        d="M11.824,7.213c-0.052,0.051-0.112,0.094-0.162,0.148C11.712,7.307,11.772,7.264,11.824,7.213z"
      ></path>
      <radialGradient
        id="wjR_Oe2ayoe3fGfJhyhbcc_LnZMjt9rZC3d_gr3"
        cx="11.041"
        cy="8.123"
        r=".101"
        gradientUnits="userSpaceOnUse"
      ...
      <path
        fill="url(#wjR_Oe2ayoe3fGfJhyhbcc_LnZMjt9rZC3d_gr3)"
        d="M11.122,8.056c-0.04,0.059-0.089,0.11-0.127,0.171l0.061-0.086	C11.076,8.111,11.102,8.086,11.122,8.056z"
      ></path>
      <radialGradient
        id="wjR_Oe2ayoe3fGfJhyhbcd_LnZMjt9rZC3d_gr4"
        cx="31.824"
        cy="28.562"
        r=".004"
        gradientUnits="userSpaceOnUse"
      ...
      <polygon
        fill="url(#wjR_Oe2ayoe3fGfJhyhbcd_LnZMjt9rZC3d_gr4)"
        points="31.829,28.563 31.822,28.561 31.819,28.563"
      ></polygon>
      <linearGradient
        id="wjR_Oe2ayoe3fGfJhyhbce_LnZMjt9rZC3d_gr5"
        x1="16.012"
        x2="29.033"
        y1="26.093"
        y2="26.476"
      ...
      <path
        fill="url(#wjR_Oe2ayoe3fGfJhyhbce_LnZMjt9rZC3d_gr5)"
...
export function Hackerrank(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="2.3em"
...
export function Interviewbit(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="2.5em"
    ...
    >
      <polygon
        fill="#fff"
        points="86,53 77,44 68,35 59,26 50,17 41,26 32,35 23,44 14,53 5,62 14,71 23,62 32,71 41,62 50,71 59,62 68,71 77,62 86,71 95,62"
      ></polygon>
      <rect
        width="12.374"
        height="12.374"
        ...
        y="19.563"
        fill="#39c1d7"
        transform="rotate(-45.001 50 25.75)"
      ></rect>
      <rect
        width="12.252"
        height="12.374"
        ...
        y="37.269"
        fill="#f9b621"
        transform="rotate(-45.001 32.293 43.457)"
      ></rect>
      <rect
        width="13.081"
        height="12.728"
        ...
        y="55.511"
        fill="#39c1d7"
        transform="rotate(-45.001 14.124 61.875)"
      ></rect>
      <rect
        width="12.374"
        height="12.728"
        ...
        y="37.261"
        fill="#f9b621"
        transform="rotate(-45.001 67.875 43.626)"
      ></rect>
      <rect
        width="12.728"
        height="12.728"
        ...
        y="37.136"
        fill="#f9b621"
        transform="rotate(-45.001 50 43.5)"
      ></rect>
      <rect
        width="13.081"
        height="13.081"
        ...
        y="55.209"
        fill="#39c1d7"
        transform="rotate(-45.001 32 61.75)"
      ></rect>
      <rect
        width="12.61"
        height="13.081"
        ...
        y="55.376"
        fill="#39c1d7"
        transform="rotate(-45.001 49.833 61.918)"
      ></rect>
      <rect
        width="13.081"
        height="13.081"
        ...
        y="55.209"
        fill="#39c1d7"
        transform="rotate(-45.001 68 61.751)"
      ></rect>
      <rect
        width="12.728"
        height="12.608"
        ...
        y="55.738"
        fill="#39c1d7"
        transform="rotate(-45.001 86.042 62.044)"
      ></rect>
      <g>
        <path
          fill="#1f212b"
          d="M25.713,46.713c-0.128,0-0.256-0.049-0.354-0.146l-2.463-2.463c-0.195-0.195-0.195-0.512,0-0.707 s0.512-0.195,0.707,0l2.463,2.463c0.195,0.195,0.195,0.512,0,0.707C25.969,46.664,25.841,46.713,25.713,46.713z"
        ></path>
        <path
          fill="#1f212b"
          d="M41,62c-0.128,0-0.256-0.049-0.354-0.146l-13.25-13.25c-0.195-0.195-0.195-0.512,0-0.707 s0.512-0.195,0.707,0L41,60.793l26.396-26.396c0.195-0.195,0.512-0.195,0.707,0s0.195,0.512,0,0.707l-26.75,26.75 C41.256,61.951,41.128,62,41,62z"
        ></path>
        <path
          fill="#1f212b"
          d="M50,53c-0.128,0-0.256-0.049-0.354-0.146l-17.75-17.75c-0.195-0.195-0.195-0.512,0-0.707 s0.512-0.195,0.707,0l17.75,17.75c0.195,0.195,0.195,0.512,0,0.707C50.256,52.951,50.128,53,50,53z"
        ></path>
        <path
          fill="#1f212b"
          d="M59,62c-0.128,0-0.256-0.049-0.354-0.146l-7.035-7.035c-0.195-0.195-0.195-0.512,0-0.707 s0.512-0.195,0.707,0L59,60.793l17.396-17.396c0.195-0.195,0.512-0.195,0.707,0s0.195,0.512,0,0.707l-17.75,17.75 C59.256,61.951,59.128,62,59,62z"
        ></path>
        <path
          fill="#1f212b"
          d="M77,62c-0.128,0-0.256-0.049-0.354-0.146l-35.75-35.75c-0.195-0.195-0.195-0.512,0-0.707 s0.512-0.195,0.707,0L77,60.793l4.927-4.927c0.195-0.195,0.512-0.195,0.707,0s0.195,0.512,0,0.707l-5.28,5.28 C77.256,61.951,77.128,62,77,62z"
        ></path>
        <path
          fill="#1f212b"
          d="M84.035,54.965c-0.128,0-0.256-0.049-0.354-0.146c-0.195-0.195-0.195-0.512,0-0.707l1.715-1.715 c0.195-0.195,0.512-0.195,0.707,0s0.195,0.512,0,0.707l-1.715,1.715C84.291,54.916,84.163,54.965,84.035,54.965z"
        ></path>
        <path
          fill="#1f212b"
          d="M23,62c-0.128,0-0.256-0.049-0.354-0.146l-8.75-8.75c-0.195-0.195-0.195-0.512,0-0.707 s0.512-0.195,0.707,0L23,60.793l35.396-35.396c0.195-0.195,0.512-0.195,0.707,0s0.195,0.512,0,0.707l-35.75,35.75 C23.256,61.951,23.128,62,23,62z"
        ></path>
      </g>
      <path
        fill="#1f212b"
        d="M86,72c-0.256,0-0.512-0.098-0.707-0.293L77,63.414l-8.293,8.293c-0.391,0.391-1.023,0.391-1.414,0	L59,63.414l-8.293,8.293c-0.391,0.391-1.023,0.391-1.414,0L41,63.414l-8.293,8.293c-0.391,0.391-1.023,0.391-1.414,0L23,63.414	l-8.293,8.293c-0.391,0.391-1.023,0.391-1.414,0l-9-9c-0.391-0.391-0.391-1.023,0-1.414l45-45c0.391-0.391,1.023-0.391,1.414,0	l45,45c0.391,0.391,0.391,1.023,0,1.414l-9,9C86.512,71.902,86.256,72,86,72z M77,61c0.256,0,0.512,0.098,0.707,0.293L86,69.586	L93.586,62L50,18.414L6.414,62L14,69.586l8.293-8.293c0.391-0.391,1.023-0.391,1.414,0L32,69.586l8.293-8.293	c0.391-0.391,1.023-0.391,1.414,0L50,69.586l8.293-8.293c0.391-0.391,1.023-0.391,1.414,0L68,69.586l8.293-8.293	C76.488,61.098,76.744,61,77,61z"
      ></path>
    </svg>
  );
}
...
export function Matplotlib(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="2em"
    ...
    >
      ...
      <path
        fill="#2c2c2c"
        d="m77.551 64.198l-13.576-.001a.414.414 0 0 1-.128-.806l12.912-4.194a.413.413 0 0 1 .521.265c.455 1.398.685 2.853.684 4.323a.413.413 0 0 1-.413.413m-10.965-.828h10.545a13.114 13.114 0 0 0-.516-3.258z"
      ></path>
      <path
        fill="#2c2c2c"
        d="M63.975 64.197a.414.414 0 0 1-.387-.558L77.899 25.51a.412.412 0 0 1 .532-.242a41 41 0 0 1 11.196 6.351a.414.414 0 0 1 .066.581L64.298 64.041a.415.415 0 0 1-.323.156m14.552-38.008L65.28 61.484l23.507-29.475a40.163 40.163 0 0 0-10.26-5.82"
      ></path>
      <path
        fill="#2c2c2c"
        d="M63.975 64.197a.415.415 0 0 1-.317-.148L28.857 22.364a.412.412 0 0 1 .052-.582A54.784 54.784 0 0 1 51.801 10.44a.414.414 0 0 1 .495.312l12.083 52.941a.415.415 0 0 1-.22.463a.444.444 0 0 1-.184.041M29.757 22.152l33.431 40.044l-11.607-50.857a53.967 53.967 0 0 0-21.824 10.813"
      ></path>
      <path
        fill="#2c2c2c"
        d="M17.224 72.681a.413.413 0 0 1-.406-.339c-1.813-9.884-.401-20.309 3.977-29.355a.414.414 0 0 1 .552-.193l42.808 20.615a.413.413 0 0 1-.106.78l-46.75 8.485a.318.318 0 0 1-.075.007m4.136-28.96c-4.103 8.678-5.448 18.61-3.801 28.067l45.09-8.183z"
      ></path>
      <path
        fill="#2c2c2c"
        d="M41.657 79.659a.42.42 0 0 1-.341-.178a27.673 27.673 0 0 1-2.177-3.738a.413.413 0 0 1 .193-.552l24.462-11.78a.413.413 0 0 1 .415.713L41.893 79.586a.414.414 0 0 1-.236.073m-1.59-3.904a27.058 27.058 0 0 0 1.697 2.913L59.42 66.436z"
      ></path>
      <path
        fill="#2c2c2c"
        d="M63.99 98.132c-2.58 0-5.165-.287-7.66-.857a.415.415 0 0 1-.311-.496l7.552-33.088c.044-.192.223-.354.415-.321a.412.412 0 0 1 .396.344l5.685 33.46a.414.414 0 0 1-.339.477a34.201 34.201 0 0 1-5.738.481m-7.072-1.574c4 .86 8.22.98 12.264.344l-5.267-30.999z"
      ></path>
      <path
        fill="#2c2c2c"
        d="M97.832 106.652a.413.413 0 0 1-.324-.156L63.651 64.041a.413.413 0 0 1 .577-.584l42.833 33.379a.414.414 0 0 1 .072.581a54.697 54.697 0 0 1-9.045 9.146a.409.409 0 0 1-.256.089M66.477 66.258l31.42 39.399a53.985 53.985 0 0 0 8.329-8.423z"
      ></path>
    </svg>
  );
}

export function Seaborn(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="2em"
    ...
    >
      ...
      <path
        fill="#444876"
        d="M104.897 147.13v15.493h27.72v21.396h27.72v14.634h27.72v6.177h27.72v5.399a120.277 120.277 0 0 1-133.81 28.893a120.284 120.284 0 0 1-60.231-54.77v-14.434h27.72V150.61h27.72v-3.48z"
      ></path>
      <path
        fill="#fff"
...
export function Sklearn(props) {
  return (
    ...
    >
      <path
        fill="#f89939"
        d="M98.18 88.13c15.63-15.62 18.23-38.36 5.8-50.78c-12.43-12.42-35.17-9.82-50.8 5.8c-15.63 15.62-11.11 45.48-5.8 50.78c4.29 4.29 35.17 9.82 50.8-5.8"
      ></path>
      <path
        fill="#3499cd"
...
export function Apache(props) {
  return (
    ...
    >
      ...
      ></path>
      <use href="#deviconApachec"></use>
      <use href="#deviconApachec" opacity={0.35}></use>
      <path
        fill="url(#deviconApache7)"
        d="M73.516 58.729c-.245.044-.49.081-.741.111c.252-.022.503-.067.74-.111Z"
      ></path>
      <use href="#deviconApached"></use>
      <use href="#deviconApached" opacity={0.35}></use>
      <path
        fill="url(#deviconApache8)"
        d="M75.449 52.566c.074-.007.155-.022.23-.037c-.075.008-.149.03-.23.037"
      ></path>
      <use href="#deviconApachee"></use>
      <use href="#deviconApachee" opacity={0.35}></use>
      <path
        fill="url(#deviconApache9)"
      ...
      <defs>
        ...
        >
          ...
          <stop offset={0.312} stopColor="#f69822"></stop>
          <stop offset={0.838} stopColor="#e87726"></stop>
        </linearGradient>
        <linearGradient
          id="deviconApache1"
          x1={21.611}
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset={0.323} stopColor="#9c2063"></stop>
          <stop offset={0.63} stopColor="#c82037"></stop>
          <stop offset={0.751} stopColor="#cc2135"></stop>
        ...
        >
          ...
          <stop offset={0.095} stopColor="#662e8c"></stop>
          <stop offset={0.788} stopColor="#9e2064"></stop>
          <stop offset={0.949} stopColor="#cc2032"></stop>
        </linearGradient>
        <linearGradient
          id="deviconApache3"
          x1={23.576}
        ...
        <path
          id="deviconApacheb"
          fill="#bd202e"
          d="M75.456 52.559s0 .007 0 0c-.007 0-.007 0-.007.007c.074-.007.155-.022.23-.037c.31-.044.614-.096.91-.17c-.37.067-.74.133-1.133.2"
        ></path>
        <path
          id="deviconApachec"
          fill="#bd202e"
...
export function Postman(props) {
  return (
    ...
    >
      ...
      ></path>
      <g fill="#fff" strokeWidth={0.88}>
        <path d="M12.121 16.885a.053.053 0 0 0 .062.028l2.24-.483l-.943-.955l-1.342 1.343a.052.052 0 0 0-.017.067M22.61 7.267a2.087 2.087 0 1 0 .88 3.981l-1.42-1.42a.175.175 0 0 1 0-.247l1.855-1.854a2.087 2.087 0 0 0-1.315-.46"></path>
        <path d="M24.18 7.968L22.441 9.7l1.364 1.364a2.1 2.1 0 0 0 .375-3.095zm-3.479 3.196h-.03a.546.546 0 0 0-.109.01h-.012a.821.821 0 0 0-.115.033l-.03.014a.549.549 0 0 0-.08.042l-.031.02a.729.729 0 0 0-.096.078l-5.156 5.158l.639.638l5.46-4.792a.635.635 0 0 0 .084-.09l.023-.03a.762.762 0 0 0 .097-.205c0-.016.01-.033.014-.05a.82.82 0 0 0 .014-.105v-.122c0-.025 0-.033-.007-.05a.68.68 0 0 0-.533-.536h-.027a.735.735 0 0 0-.105-.013m-6.979 4.063l1.058 1.053l5.17-5.17c.169-.165.388-.267.622-.29c-.914-.7-1.91-.517-6.85 4.407m7.71-2.66l-.063.062l-5.46 4.79l.928.927c2.302-2.177 4.344-4.25 4.595-5.779M7.812 23.791a.05.05 0 0 0 .045.036l2.38.164l-1.334-1.334l-1.08 1.078a.053.053 0 0 0-.01.056zm1.34-1.382l1.407 1.407a.107.107 0 0 0 .133.018a.105.105 0 0 0 .055-.122l-.237-1.01a.302.302 0 0 1 .156-.338c2.466-1.236 4.456-2.509 5.916-3.78l-.98-.98l-2.1.452zm6.149-5.101l-.526-.526l-.728.726a.035.035 0 0 0 0 .045a.034.034 0 0 0 .04.018z"></path>
      </g>
      <path
        fill="#ff6c37"
        d="M24.229 9.097a.163.163 0 1 0-.29.14a.487.487 0 0 1-.06.526a.162.162 0 0 0 .25.207a.81.81 0 0 0 .1-.873"
      ></path>
    </svg>
  );
}
...
export function NextJs({ width = 40, height = 40, ...props }) {
  return (
    <svg
      viewBox="0 0 512 512"
      xmlns="http://www.w3.org/2000/svg"
